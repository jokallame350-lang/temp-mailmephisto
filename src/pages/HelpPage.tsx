...
const faqs = {
    en: [
        ...
        { q: 'Can I receive OTP verification codes?', a: 'Yes! MephistoMail uses automated rapid inbox synchronization for instant email delivery, making it perfect for receiving OTP codes, verification links, and confirmation emails.' },
        ...
        { q: 'What is the difference between MephistoMail and Mailinator?', a: 'MephistoMail offers stronger privacy (RAM-only storage, zero logging), rapid automated delivery, up to 100 simultaneous accounts, and a modern dark-mode interface — all for free.' },
    ...
    tr: [
        ...
        { q: 'OTP doğrulama kodlarını alabilir miyim?', a: 'Evet! MephistoMail, hızlı otomatik senkronizasyon ile anlık e-posta teslimatı sağlar — OTP kodları, doğrulama linkleri ve onay e-postaları saniyeler içinde gelir.' },
        ...
        { q: 'MephistoMail ile Mailinator arasındaki fark nedir?', a: 'MephistoMail daha güçlü gizlilik (RAM-only depolama, sıfır kayıt), hızlı otomatik gelen kutusu teslimatı, 100 eş zamanlı hesap ve modern koyu tema arayüzü sunar — hepsi ücretsiz.' },
