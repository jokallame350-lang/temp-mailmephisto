                    ...
                    <div className="text-slate-400 text-sm space-y-4 leading-relaxed">
                        {lang === 'tr' ? (
                            <>
                                ...
                                <p>MephistoMail'in 10 dakikalık mail servisi, otomatik hızlı senkronizasyon sayesinde gelen e-postaları anlık olarak gösterir. Sayfayı yenilemenize gerek yoktur — yeni bir e-posta geldiği anda ekranınızda belirir. İster doğrulama kodu, ister onay linki, ister bildirim e-postası olsun, saniyeler içinde alırsınız.</p>
