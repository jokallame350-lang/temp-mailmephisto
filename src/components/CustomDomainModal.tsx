...
export const CustomDomainModal: React.FC<CustomDomainModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-2xl bg-slate-900 border border-slate-700/60 rounded-2xl shadow-2xl overflow-hidden text-slate-100">
        {/* Header */}
              ...
              <div className="p-4 bg-slate-950/60 rounded-xl border border-slate-800 space-y-2">
                ...
                <div className="flex items-center justify-between bg-slate-900 px-3 py-2 rounded-lg border border-slate-800 text-sm font-mono">
                  ...
                  <button
                    ...
                    className="ml-2 px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded text-xs flex items-center space-x-1.5 transition-colors"
                  >
                    {copiedField === 'mx' ? (
                      <>
