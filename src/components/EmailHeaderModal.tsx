...
const EmailHeaderModal: React.FC<EmailHeaderModalProps> = ({ isOpen, onClose, email, lang }) => {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="bg-[#0a0a0c] border border-white/10 rounded-3xl p-6 max-w-2xl w-full shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-150"
      >
        <div className="flex items-center justify-between pb-4 border-b border-white/5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 id="header-modal-title" className="text-sm font-bold text-white uppercase tracking-wider">
          ...
          <button
            ...
            className="p-2 hover:bg-white/5 rounded-xl text-slate-400 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
